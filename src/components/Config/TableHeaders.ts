...
export const Product_Management_Header = [
  {
...
export const Departments_Header = [
  {
...
export const Pending_Loans_Header = [
  {
    name: "Application No",
    selector: (row: { ApplicationNo: any }) => row.ApplicationNo,
  },
...
export const InProgress_Loans_Header = [
  {
    name: "Application No",
    selector: (row: { ApplicationNo: any }) => row.ApplicationNo,
  },
...
export const Approved_Loans_Header = [
  {
    name: "Application No",
    selector: (row: { ApplicationNo: any }) => row.ApplicationNo,
  },
