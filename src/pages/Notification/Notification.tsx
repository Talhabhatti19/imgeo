    ...
    <>
      <div className="cs-table">
        <div className="col-xl-12 col-12 d-flex align-items-center pb-3">
          <h2 className="col-xl-4 col-12 fs-6 fw-bold">Notification</h2>
          <div className="col-xl-8 col-12 d-flex justify-content-end align-items-center">
            ...
            <div className="theme-btn mt-1 button-margin">Export CSV</div>
            <div className="theme-btn mt-1 ">Add</div>
          </div>
        </div>
